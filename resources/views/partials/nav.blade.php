...
<div class="sticky top-0 z-40 bg-white sm:block hidden">
    <div class=" px-4 py-4 max-w-6xl mx-auto flex sm:flex-row flex-col justify-between items-center">
        <div class="flex  space-x-6 items-center font-semibold">
            ...
            <a href="/" class="@if($nav == 'home') text-black @else text-gray-500 @endif  sm:text-base text-xs">Home</a>
            <div @click.away="open = false" class="relative py-2" x-data="{ open: false }">
                <button @click="open = !open" class="flex flex-row items-center w-full ">
                    <a href="#" class="@if($nav == 'aboutus') text-black @else text-gray-500 @endif  sm:text-base text-xs">About us</a>
                ...
                <div class=" bg-white shadow dark-mode:bg-gray-800">
                    <a class=" block px-4 py-2  text-sm font-semibold bg-transparent  dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus: dark-mode:hover: dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="{{ route('visimisi')}}">Visi dan Misi</a>
                </div>
                <div class="  bg-white shadow dark-mode:bg-gray-800">
                    <a class=" block px-4 py-2  text-sm font-semibold bg-transparent  dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus: dark-mode:hover: dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="{{ route('staff')}}">Staff</a>
                </div>
                </div>
            ...
            <div @click.away="open = false" class="relative py-2" x-data="{ open: false }">
                <button @click="open = !open" class="flex flex-row items-center w-full ">
                    <a href="#" class="@if($nav == 'programs') text-black @else text-gray-500 @endif sm:text-base text-xs">Programs</a>
                    <svg fill="currentColor" viewBox="0 0 20 20" :class="{'rotate-180': open, 'rotate-0': !open}" class="inline w-4 h-4 items-center mt-1 ml-1 transition-transform duration-200 transform "><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                </button>
                <div x-show="open" style="display: none !important;" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute left-0 w-full mt-2 origin-top-right  shadow-lg md:w-52 z-20">
                <div class=" bg-white shadow dark-mode:bg-gray-800">
            ...
            <div @click.away="open = false" class="relative py-2" x-data="{ open: false }">
                <button @click="open = !open" class="flex flex-row items-center w-full ">
                    <a href="#" class="@if($nav == 'media') text-black @else text-gray-500 @endif sm:text-base text-xs">Galeri</a>
                    <svg fill="currentColor" viewBox="0 0 20 20" :class="{'rotate-180': open, 'rotate-0': !open}" class="inline w-4 h-4 items-center mt-1 ml-1 transition-transform duration-200 transform "><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                </button>
                <div x-show="open" style="display: none !important;" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute left-0 w-full mt-2 origin-top-right  shadow-lg md:w-52 z-20">
                <div class=" bg-white shadow dark-mode:bg-gray-800">
                    <a class=" block px-4 py-2  text-sm font-semibold bg-transparent  dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus: dark-mode:hover: dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="{{ route('foto')}}">Foto</a>
                </div>
                <div class="  bg-white shadow dark-mode:bg-gray-800">
                    <a class=" block px-4 py-2  text-sm font-semibold bg-transparent  dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus: dark-mode:hover: dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="{{ route('video')}}">Video</a>
                </div>
                </div>
        ...
        <a href="{{ route('contact')}}" class="px-4 py-3 rounded bg-mnukwar text-white sm:text-base text-xs">Contact Us</a>
    </div>
</div>
{{-- nav mobile --}}
<header class="bg-black sticky top-0 z-50 sm:hidden block">
    <div x-data="{ open: false }" class="px-6 py-4 bg-black z-10 ">
