            ...
            <div class="flex flex-col space-y-3  sm:w-4/12 w-full">
                ...
                <div class="flex flex-col space-y-2 text-white">
                    ...
                    <div class="flex space-x-2 text-xs items-center text-white">
                        ...
                        <a href="mailto:{{$footer->email}}" class="text-mnukwar">
                            {{$footer->email}}
                        </a>
                    </div>
                    <div class="flex space-x-2 text-xs items-center text-white">
                ...
                <div class="flex space-x-2">
                    <a href="https://{{$footer->facebook}}" class="h-8 w-8 rounded-full border border-white flex justify-center items-center">
                        <img src="{{ asset('img/facebook.svg') }}" alt="Mnukwar Papua" class="h-4 w-4">
                    </a>

                    <a href="https://{{$footer->twitter}}" class="h-8 w-8 rounded-full border border-white flex justify-center items-center">
                        <img src="{{ asset('img/twitter.svg') }}" alt="Mnukwar Papua" class="h-4 w-4">
                    </a>

                    <a href="https://{{$footer->instagram}}" class="h-8 w-8 rounded-full border border-white flex justify-center items-center">
